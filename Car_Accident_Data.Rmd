---
title: "How Car Accidents Make or Break Trips"
...
Visiting all states in the United States of America is a common lifelong goal for many. Achieving this goal is oftentimes difficult due to traveling in unknown terrains and locations. It's important for travelers to prepare for anything different than what they are used to in their own state. Drivers in a rainy state such as Washington takes a different kind of skill compared to those who drive in sunny Florida.

There are many factors that go into a driving experience. Some of the most important variables are dicussed and looked at, however, there are other factors that are not available or used. By looking at this car accident dataset, there is a clear idea of when it’s best to travel which results in not having to worry about transportation concerns. Questions that have the most significance and meaning are discussed and explored more in depth after the dataset is cleaned.


![50 States](../ds202_finalproject/reportPic.jpg)   
...
There were two datasets used in this project involving the crash data and the population county data of the United States. These data sets were used based on their amount of given details of the crash and current up to date population. The crash data describes the amount of accidents in the United States from February 2016 to December 2019 with over 3 million records which is worth over 1 GB of data. There are 49 columns of data to be explored including categorical and continous variables.
...
### Does the population of states and counties affect accident rates, and in the counties with the highest populations does rush hour traffic times affect accident rates?
...
### Are traffic accidents more common in the day or night and in turn does a higher or lower latitude have any correlation to the amount of traffic accidents that occur?
...
### How do warmer states compare with colder states in traffic accident rates during the summer? Do these rates change when conditioning the data only on winter months? Is this change in rates large enough to justify that harsh winter weather conditions have a high correlation to traffic accident rates?
...
### Show the distribution of visibility in traffic accidents in the US. What does the distribution tell us about the effects that different visibility levels have on how many traffic accidents occur?
...
### What are the most common weather conditions that occur during accidents? What states do these weather conditions occur at the highest rate in and are these states generally near the top of traffic accident rates when including all weather conditions?
...
### What is the relationship between the amount of precipitation on the ground and the amount of accidents that happen? How does this relationship vary when conditioned on different types of precipitation(Snow, Sleet, Rain)?
...
### Between the 2017 and 2019 how have the amount of accidents changed over all States in the US? What States accident rate has increased the most and which has decreased the most? What may be the reason for this?
